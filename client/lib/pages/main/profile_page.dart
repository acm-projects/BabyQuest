                                      ...
                                      children: [
                                        IconInformation(
                                          ...
                                          onTap: () async {
                                            ...
                                            await _showEditDialog(
                                              context: context,
                                              label: 'Gender',
                                              field: EditProfileWidgets.gender(
                                                  gender),
                                              updateData: () => currentBby
                                                  .updateData({
                                        ...
                                        IconInformation(
                                          ...
                                          onTap: () async {
                                            final weightLb =
                                                TextEditingController(
                                                    text: currentBby.weightLb
                                                        .toString());
                                            final weightOz =
                                                TextEditingController(
                                                    text: currentBby.weightOz
                                                        .toString());
                                            ...
                                            await _showEditDialog(
                                                ...
                                                label: 'Weight',
                                                field:
                                                    EditProfileWidgets.weight(
                                                        weightLb, weightOz),
                                                updateData: () => currentBby
                                                        .updateData({
                                                      'weightLb': double.parse(
                                                          weightLb.text),
                                                      'weightOz': double.parse(
                                                          weightOz.text)
                                                    }));
                                          },
                                        ),
                                  ...
                                  children: [
                                    IconInformation(
                                      ...
                                      onTap: () async {
                                        final pediatrician =
                                            TextEditingController(
                                                text: currentBby.pediatrician);

                                        await _showEditDialog(
                                          context: context,
                                          label: 'Pediatrician Name',
                                          field:
                                              EditProfileWidgets.pediatrician(
                                                  pediatrician),
                                          updateData: () => currentBby
                                              .updateData({
                                    ...
                                    IconInformation(
                                      ...
                                      onTap: () async {
                                        final pedPhone = TextEditingController(
                                            text: currentBby.pediatricianPhone);
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              LabeledIconButton(
                                ...
                                onPressed: () {
                                  launch(
                                      'tel://' + currentBby.pediatricianPhone);
                                },
                              ),
                              const Spacer(),
                              LabeledIconButton(
